import IKycAggregator from './abi/IKycAggregator.json'

export const IKycAggregatorABI = IKycAggregator
export const kycAggregatorAddress: string =
  '0x068251617f0c1851a75c109f3d114462a3a3c2f7'
export const donHostedSecretsSlot: string = '0'
export const donHostedSecretsVersion: string = '1716222927'
export const baseApiUrl: string = 'https://cloud.kycwonder.workers.dev/api'
